...
description: Use this skill whenever the user wants to audit, optimize, or reposition a LinkedIn profile toward a specific target role or designation — e.g. "optimize my LinkedIn for a Staff Engineer role," "how does my profile look for VP Engineering," "help me reposition my LinkedIn for Product Management," or any request to review a LinkedIn export/PDF against a job title, career direction, or job description. Trigger this even if the user only provides a LinkedIn PDF with no resume, and even if they don't use the word "skill" — any profile-vs-role positioning request qualifies. Requires a LinkedIn profile export (PDF) and a target designation; a resume is optional but improves the result.
---
